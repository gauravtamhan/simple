    ...
    <div class="row error no-row-spacing">
      <div class="col full m10 offset-m1">
        <div style="margin: 0 auto;">
          ...
          <h3 class="error-message"><?php _e("Page not found", "minimal"); ?></h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container content no-floating-footer">
    <div class="row">
      ...
      <p class="flow-text error-message"><?php _e("Looks like the page you are looking for doesn't exist.
        You can select a menu item above to navigate to another page on this site or go back to your previous page.", "minimal"); ?></p>
      <a href="javascript:window.history.back()" class="waves-effect waves-teal btn-flat"><?php _e("Go Back", "minimal"); ?></a>
      </div>
    </div>
    <!-- <div class="bumper"></div> -->
  </div>
